...
echo "TARGET_PROFILE=$TARGET_PROFILE" >> $GITHUB_ENV   # 设备硬件架构
echo "OP_VERSION=$OP_VERSION" >> $GITHUB_ENV           # 固件版本号
echo "OP_AUTHOR=$OP_AUTHOR" >> $GITHUB_ENV             # 仓库作者
echo "OP_REPO=$OP_REPO" >> $GITHUB_ENV                 # 仓库地址
echo "OP_BRANCH=$OP_BRANCH" >> $GITHUB_ENV             # 仓库分支名
